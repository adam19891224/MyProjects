...
if (window.jQuery && !window.jQuery.createTemplate) {(function (jQuery) {
	...
	/**
	 * Split multitemplate into multiple templates1.
	 * @param {string} s A template string (like: "Text: {$T.txt}.").
	 * @param {array} includes Array of included templates1.
	 */
	...
	/**
	 * Check it HTML Elements have a template. Return count of templates1.
	 * @return {number} Number of templates1.
	 * @memberOf jQuery.fn
	 */
	...
	/**
	 * Create new HTTP request to server, get data (as JSON) and send it to templates1. Also check does HTMLElements still exists in Document.
	 */
